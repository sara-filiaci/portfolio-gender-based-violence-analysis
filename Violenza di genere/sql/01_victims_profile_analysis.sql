...
-- in Italy using datasets describing demographic and
...
-- =========================================================
-- Some territorial units are not represented consistently
-- across all victim-related datasets.
--
-- In particular, Trento, Bolzano, and Valle d'Aosta may appear
-- differently depending on the source table used
-- (for example: violence type, age, or marital status).
--
-- For this reason, each query reflects the actual territorial
-- coverage available in its specific source table.
-- Results should therefore be compared with caution
-- across sections when minor territorial differences appear.